                  ...
                  >
                    ...
                    <td className="py-4">
                      <div className="flex items-center gap-2">
                        ...
                        {isNoStock ? (
                          <span className="text-xs text-white flex items-center gap-1 px-2 py-0.5 bg-red-300 rounded-full">
                            No Stock
                          </span>
                        ) : isLow ? (
                          <span className="text-xs text-white flex items-center gap-1 px-2 py-0.5 bg-yellow-300 rounded-full">
